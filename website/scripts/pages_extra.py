...
def build_threads_page(books, output_dir, env, threads, tindex):
    ...
    for thi, th in enumerate(threads):
        ...
        for b in bord:
            ...
            glist.append('<div class="tstop" data-n="' + str(step).zfill(2) + '"><b>' + htmllib.escape(b['title']) + '</b><div class="chiprow">' + chips + '</div></div>')
