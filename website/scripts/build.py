...
.pipeline{position:absolute;inset:0;margin:0 auto;max-width:1060px;height:300px;pointer-events:none;opacity:.4;z-index:0}
...
@media(max-width:600px){.pipeline{opacity:.16;height:230px}.herocta{flex-direction:column;align-items:stretch;max-width:320px;margin-left:auto;margin-right:auto}.herocta .btn{justify-content:center}}
