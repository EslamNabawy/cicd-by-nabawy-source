...
header.top .search,header.top #qcount,header.top #markbtn,header.top .reader-nav{display:none}
...
header.top #tocbtn{display:inline-flex;order:2;width:38px;height:38px;padding:0;overflow:hidden;font-size:0;align-items:center;justify-content:center}
header.top #tocbtn::before{content:'☰';font-size:18px}
