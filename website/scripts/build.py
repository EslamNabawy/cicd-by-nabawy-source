...
.qbox .opts{{display:grid;grid-template-columns:1fr;gap:10px;margin-top:12px;text-align:left}}.qbox .opts .btn{{justify-content:flex-start;min-height:48px;white-space:normal;line-height:1.4;padding:12px 14px;text-align:left;overflow-wrap:anywhere}}
